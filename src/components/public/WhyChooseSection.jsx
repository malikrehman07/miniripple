...
const WhyChooseSection = () => {
    ...
    return (
        <section className="flex relative flex-col justify-start items-center self-stretch pt-20 mt-0 w-full min-h-[1300px] max-md:max-w-full z-[0] lg:top-[0px] top-[-150px]">
            ...
            <div className="flex overflow-hidden md:relative flex-col justify-center items-center md:px-2 lg:px-20 pb-2 pt-0 w-full fill-neutral-50 min-h-[1120px] max-md:px-5 max-md:py-24 max-md:max-w-full">

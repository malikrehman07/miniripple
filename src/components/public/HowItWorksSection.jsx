...
const HowItWorksSection = () => {
    ...
    return (
        <div className="relative w-full flex items- justify-center">
            <section className="max-w-full relative flex flex-col items-center justify-center px-4 md:px-0 z-[30] max-md:mt-20">
            ...
            <div className="absolute top-[-90px] md:top-[-180px] lg:top-[-260px] z-[20]">
            ...
            <div className="absolute top-[-45px] md:top-[-260px] lg:top-[-180px] z-[20]">
                <div className="hidden w-full lg:block">
                    <svg xmlns="http://www.w3.org/2000/svg" width={width} height="1413" viewBox={`0 0 ${width} 1413`} fill="none">

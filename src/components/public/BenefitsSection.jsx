...
const BenefitsSection = () => {
    return (
        <section className="relative flex flex-col items-center self-stretch md:px-10 lg:px-24 w-full text-center z-[10] max-md:px-5 max-md:max-w-full lg:mb-[0px] mb-[-200px]">
